...
function MinusSquare(props: any) {
  return (
    <SvgIcon className='svg-icon' fontSize='inherit' style={{ width: 14, height: 14 }} {...props}>
...
function CloseSquare(props: any) {
  return (
    <SvgIcon className='svg-icon close' fontSize='inherit' style={{ width: 14, height: 14 }} {...props}>
      {/* tslint:disable-next-line: max-line-length */}
